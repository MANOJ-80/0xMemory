...
class LLMProviderConfig(BaseModel):
    ...
    api_key_env: Optional[str] = Field(default=None, description="API key env var")
    host: Optional[str] = Field(default=None, description="Custom host URL")
...
class BrainInfo(BaseModel):
    ...
    def total_memories(self) -> int:
        ...
        return (
            ...
            + self.learnings_count 
            + self.preferences_count
        )
